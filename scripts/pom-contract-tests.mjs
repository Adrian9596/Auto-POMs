...
const ASSERTIONS = [
  ...
  },
  {
    ...
    test: (c) => {
      ...
      const ok = src === 'seam'
        || ((src === 'seamProjected' || src === 'seamDip') && anc.reviewRequired === true);
  ...
  {
    id: 'C7.seam-source', name: 'POM 7 anchors are seam-sourced (not ratio)',
    require: (c) => has(c, 'cradle-cup-top'),
    test: (c) => {
      const src = a(c, 'cradle-cup-top').source;
      return { ok: src === 'seam', msg: `source=${src}` };
    },
  },
  {
